...
class Gui(QtWidgets.QMainWindow):
    ...
    def se_puede_reemplazar_msg(self,codigo,placa_nueva,camara):
        ...
        if (camara =='ENTRADA'):
            placa_actual=QString(self.ui.resultado_e.text());
            ...
            placa_actual=QString(self.ui.resultado_s.text());
            ...
            placa_actual=QString(self.ui.resultado_e_2.text());
            ...
            placa_actual=QString(self.ui.resultado_s_2.text());
        ...
        if (placa_actual == QString("??????")):
            retorno=True;
        else:
            if placa_nueva != QString("??????"):
                #print('placa_actual'+placa_actual);
                #print('placa_nueva'+placa_nueva);
                if (placa_actual == QString(placa_nueva)):
    ...
    def generar_recibo(self,placa,hora_entrada,fecha_entrada,nombre,pagado,minutos,nombre_parqueadero,direccion_parqueadero,numero):
        ...
        #page = PdfFileReader(open("ticket_limpio_80x_100.pdf","rb")).getPage(0)
        ...
        #output.write(open(nombre_tiquete,"w"))
